        ...
        if ($file) {
            ...
            if ($file['size'] <= 2097152) {
                ...
                if ($width <= $maxWidth && $height <= $maxHeigth) {
                    // Se comprueba si el tipo de imagen es permitido (1 - GIF, 2 - JPG y 3 - PNG), de lo contrario se establece el mensaje de error correspondiente.
                    if ($type == 1 || $type == 2 || $type == 3) {
                        ...
                        $this->fileError = 'El tipo de la imagen debe ser gif, jpg o png';
                        return false;
                    }
                } else {
