        ...
        content += `
            <tr>
                ...
                <td>
                    ...
                    <a href="../../app/reports/admin/equiposTipo.php?id=${row.idtipoequipo}" target="_blank" class="btn waves-effect amber tooltipped" data-tooltip="Reporte de Equipos"><i class="material-icons">assignment</i></a>
                </td>
            </tr>
        `;
    });
